...
\begin{Figure}  
  {\includegraphics[width=0.99\textwidth]{C:/Users/dsbjr/Documents/DissertationProposal/images/activationEnergySweepsTawdryOwl}\label{fig:f2}}
  \captionof{figure}{Thermal activation measurements with ionic liquid applied}
\end{Figure}
...
\begin{Figure}
  ...
  \captionof{figure}{Raman spectra for exfoliated and bulk \rucl samples, offset for clarity}
\end{Figure}
