...
Thermal activation energy extracted from resistance-temperature curves of \rucl3 at fixed ionic liquid voltages show only minor changes as a function of gate voltage. However, room temperature gate sweeps show some small repeatable structure, which may be related to charge localization.

I will make in-situ resistivity measurements of exfoliated \rucl3 while measuring Raman spectra. I will compare changes in resistivity to changes in Raman spectra as a function of gate voltage and draw conclusions about localization from the comparison.
...
\begin{itemize}
	...
	\item Measure \rucl3 resistivity, gate current, and Raman spectra at various gate voltages in the electrochemical stability window of the ionic liquid. 
\end{itemize}
